...
class ModelThreeClass(nn.Module):
    def __init__(self):
        ...
        self.relu1 = nn.ReLU()
        # input: 148x148x4
        self.conv2 = nn.Conv2d(conv1_output_channels, conv2_output_channels, kernel_size, stride)
        self.relu2 = nn.ReLU()
        # input: 146x146x8
        self.pool = nn.MaxPool2d(2, 2)
        # input: 73x73x8
        self.conv3 = nn.Conv2d(conv2_output_channels, conv3_output_channels, kernel_size, stride)
        self.relu3 = nn.ReLU()
        # input: 71x71x16
        self.fc1 = nn.Linear(80656, 3)
